-- Migration: 20251017215132_dabc3566-01f8-4942-a81c-761ea22949fc.sql
BEGIN;
...
-- Migration: 20251024134915_9905292c-09b8-4e35-9cb5-f21fb8e32ed6.sql
BEGIN;
-- ============================================
...
-- Migration: 20251024135225_278451b9-1b79-4308-a50b-b391bea0420c.sql
BEGIN;
-- ============================================
-- MIGRACIÓN: MÓDULO AGENDA Y CITAS COMPLETO
-- ============================================
...
-- Migration: 20251024135301_b39ba636-48c9-4adc-8013-b990603620bb.sql
BEGIN;
-- ============================================
-- MIGRACIÓN: MÓDULO AGENDA Y CITAS COMPLETO
-- ============================================
...
-- Migration: 20251024145135_8dc5cdeb-6324-4d1a-b8d6-f6ded72d1b93.sql
BEGIN;
-- Crear enum de roles de aplicación
DO $$ BEGIN
...
COMMENT ON FUNCTION public.puede_cambiar_estado_cita IS 'Verifica si un usuario puede cambiar el estado de una cita según su rol';
COMMIT;

-- Migration: 20251024145405_5b6646e8-1604-4e76-bc2c-cab047e21356.sql
BEGIN;
...
-- Migration: 20251024151024_ee6d9fa1-5ac8-4ed9-8622-1328d4e9fdf1.sql
BEGIN;
...
-- Migration: 20251024151404_24abb471-0b05-4f96-9317-65fca701f169.sql
BEGIN;
...
-- Migration: 20251024151645_19d743e1-7845-4954-a9fd-53b44456c30f.sql
BEGIN;
...
-- Migration: 20251024151801_114935f8-15b3-45e9-abc8-bbe238050362.sql
BEGIN;
-- 1. Ampliar tabla clientes con expediente y saldos
ALTER TABLE public.clientes 
...
-- Migration: 20251024151906_8735367e-9d95-4810-9115-b9961eec1983.sql
BEGIN;
-- 1. Ampliar tabla clientes con expediente y saldos
ALTER TABLE public.clientes 
  ADD COLUMN IF NOT EXISTS numero_expediente VARCHAR(20),
...
-- Migration: 20251024152010_da0231f6-7e41-42d1-ba0d-fa843b8a2860.sql
BEGIN;
...
-- Migration: 20251024152040_3402f472-f0cc-4bb9-9d4c-72e0a8c55fe3.sql
BEGIN;
-- 11. Vista: Clientes ausentes
CREATE OR REPLACE VIEW public.vw_clientes_ausentes AS
WITH ultima_cita AS (
...
-- Migration: 20251024152713_15a8c0f6-6dd0-4153-aac7-33f6d0399336.sql
BEGIN;
...
-- Migration: 20251024154241_2622f44b-1539-4d1c-927b-b563a86b78dc.sql
BEGIN;
...
-- Migration: 20251024171230_e32c162e-0f57-4b9d-8cb6-b4c4e5f211be.sql
BEGIN;
...
-- Migration: 20251027162842_7f64d256-eff8-4641-9308-0ff34485ab06.sql
BEGIN;
...
-- Migration: 20251027164511_f13df512-ad88-4ebc-afdb-46ef8677cf6a.sql
BEGIN;
...
-- Migration: 20251027164556_e3e1aac4-b92c-4405-8e14-cd2acda9f8ce.sql
BEGIN;
...
-- Migration: 20251027165042_79187274-9355-4e6e-aa71-5abdb0b980a4.sql
BEGIN;
...
-- Migration: 20251027171841_fd9f1045-a2f4-4ea2-ace0-488cdb9782ac.sql
BEGIN;
-- ============================================
...
-- Migration: 20251027171918_fff4235a-a470-4594-b5dd-41e7dce2fb2b.sql
BEGIN;
-- ============================================
-- MÓDULO DE CLIENTES Y REPORTES - CEDAPIEL (CORREGIDO)
-- ============================================
...
-- Migration: 20251027172105_481e2ee0-2261-44c5-b859-4f35c5d981e0.sql
BEGIN;
...
-- Migration: 20251029144323_abace4c9-5616-4b70-ac09-e827ad08cd3f.sql
BEGIN;
-- ==========================================
...
-- Migration: 20251029150339_b2e3a764-fd40-44fe-a7cd-bfef7c7cfa32.sql
BEGIN;
-- ============================================
...
-- Migration: 20251029150455_08ccf2b4-ec9d-4ea3-b76c-af4dd763806f.sql
BEGIN;
-- ============================================
...
-- Migration: 20251029161252_6d51438d-6cac-45d1-8032-3ccd3fe7476c.sql
BEGIN;
-- ============================================
...
-- Migration: 20251029161818_4ff7b813-c895-43bb-a107-e7d1380d9220.sql
BEGIN;
-- ============================================
...
-- Migration: 20251030221949_39dcaf29-8053-431a-98a2-668fc3e187b0.sql
BEGIN;
...
-- Migration: 20251104234230_9330f843-5dff-4ae4-8438-937cddb94ca6.sql
BEGIN;
...
-- Migration: 20251104235905_15ed8fa2-7139-4637-8000-a2498532870d.sql
BEGIN;
...
-- Migration: 20251105002741_3ae331a3-b9b1-4b86-9836-f62c85b59bcb.sql
BEGIN;
...
-- Migration: 20251105155943_b312ea9c-9b85-40ca-8ab7-50e9e11fdbb8.sql
BEGIN;
...
-- Migration: 20251105160049_120c7fcb-58cc-4223-bdb6-3acb903773a6.sql
BEGIN;
-- Agregar columnas para el sistema POS en la tabla ventas
ALTER TABLE public.ventas 
ADD COLUMN IF NOT EXISTS estado VARCHAR(50) DEFAULT 'borrador',
...
-- Migration: 20251105161030_63cec25e-7467-4368-a61d-13e700c74dd8.sql
BEGIN;
...
-- Migration: 20251106114303_224d92ec-c111-4fb8-853d-b1b0cbf299f1.sql
BEGIN;
...
-- Migration: 20251106114414_d47b43ae-ff8c-4986-ae49-9556f7f05396.sql
BEGIN;
...
-- Migration: 20251106120931_40deb7cb-2d4e-4725-95ac-dd4d9e6eea2a.sql
BEGIN;
...
-- Migration: 20251106131038_520a64a9-6213-424b-930e-4baf4294240d.sql
BEGIN;
...
-- Migration: 20251106131636_8e52423c-e8cf-46af-9310-53711586cc40.sql
BEGIN;
-- Agregar tabla ventas a la publicación de realtime
ALTER PUBLICATION supabase_realtime ADD TABLE public.ventas;
COMMIT;

-- Migration: 20251106131918_be6e1d64-ec25-4195-a76f-30e75ce76fc0.sql
BEGIN;
...
-- Migration: 20251113101719_6c87a02e-12cb-4f37-bbbe-32b0b8d5b25a.sql
BEGIN;
-- ============================================
...
-- Migration: 20251113121033_e54d4cb9-fff9-4e81-a992-4261d8b824ae.sql
BEGIN;
...
-- Migration: 20251114114106_81045bdd-0df2-4db3-96d4-94fed337c29b.sql
BEGIN;
...
-- Migration: 20251114114600_425b43d7-92df-4469-ba23-c1ed1c535ee3.sql
BEGIN;
...
-- Migration: 20251114120409_bbe0cd23-1a67-4001-b220-eebd44d5e0e1.sql
BEGIN;
...
-- Migration: 20251122005709_092d64b9-bd42-4c70-a5c9-128619ddb7dc.sql
BEGIN;
...
-- Migration: 20251122011250_79c005a2-8507-49a9-9a72-362a0973010f.sql
BEGIN;
...
-- Migration: 20251122012428_6f48a7a8-ed5b-45b8-899d-5c6cb1bd98cb.sql
BEGIN;
...
-- Migration: 20251122020231_2d9e4b3d-fd84-4988-9c4c-2c5b60787111.sql
BEGIN;
...
-- Migration: 20251122021532_cb00ede9-dff4-49dd-8e18-bc304281c5bf.sql
BEGIN;
...
-- Migration: 20251122023154_da8ec67d-6196-412d-8346-5d9d3f425425.sql
BEGIN;
...
-- Migration: 20251122025440_295f32ab-a701-4999-a773-afa8a0c5c7a2.sql
BEGIN;
...
-- Migration: 20251122030437_a8233aba-1d07-4418-b9a3-8395b02583e2.sql
BEGIN;
...
-- Migration: 20251122031202_cc28f79c-3815-4233-a2dd-7bdbabf9a834.sql
BEGIN;
...
-- Migration: 20251122032941_8bb4405a-0b3f-4f7a-9c1f-d4718d7cb716.sql
BEGIN;
...
-- Migration: 20251123001632_a460f806-c47b-497a-90bc-d9b537269d8b.sql
BEGIN;
...
-- Migration: 20251123002819_89feaf88-f411-467b-aac5-9cf3b555b5e7.sql
BEGIN;
...
-- Migration: 20251123004416_e4682b7d-d264-48ff-966f-af9ac00796d7.sql
BEGIN;
...
-- Migration: 20251124185203_0e5ed73b-bbb7-4ad0-9c1b-fa38c93d0cb3.sql
BEGIN;
-- Borrar todos los datos de las tablas de reportes importados
...
DELETE FROM facturacion_detalle;
COMMIT;

-- Migration: 20251124185523_7f87170b-bb07-4278-aeb7-9e1d0b803936.sql
BEGIN;
...
-- Migration: 20251124185700_75f3b6cc-23b5-4806-8fbe-f49275883c33.sql
BEGIN;
-- Borrar datos de la tabla ventas_detalle
DELETE FROM ventas_detalle;
COMMIT;

-- Migration: 20251125150943_2c94b05b-abf2-4e74-835c-0ba30694a740.sql
BEGIN;
...
-- Migration: 20251125151541_b0dff80a-cf4d-4236-bc3a-8739b2508441.sql
BEGIN;
...
-- Migration: 20251128015219_01c49215-c382-47d1-9680-950007616d0b.sql
BEGIN;
...
-- Migration: 20251128023422_d521c359-d270-415e-88ab-f78a6b387d85.sql
BEGIN;
...
-- Migration: 20251128023826_13fc4179-1b77-49ca-b86a-174a309ca200.sql
BEGIN;
...
-- Migration: 20251128024352_368769d5-fc10-4468-b179-d9bf8db6e793.sql
BEGIN;
...
-- Migration: 20251128034956_2a0d6658-a5b1-4c42-a720-5dc1653d8d50.sql
BEGIN;
...
-- Migration: 20251128181151_0011c1e7-ecf3-4970-9f21-cbfa244ee67a.sql
BEGIN;
...
-- Migration: 20251128183213_f2722e2f-d336-4be5-ad00-61f1bf688c06.sql
BEGIN;
...
-- Migration: 20251128190338_9565d000-1e83-4bcb-8b64-e0c4e6c70dfd.sql
BEGIN;
...
-- Migration: 20251128190549_271814a0-e66c-49a3-931f-4070303fbd4c.sql
BEGIN;
...
-- Migration: 20251130154143_fc6f6885-5a30-4fbd-96af-44011ca32a29.sql
BEGIN;
...
-- Migration: 20251130160548_0bd1e47a-39e1-4c58-8d49-5ae32d6cd918.sql
BEGIN;
...
-- Migration: 20251201043052_00967612-de39-4e2e-952f-cf0a25a65780.sql
BEGIN;
...
-- Migration: 20251204012708_ceafd2c3-2c58-486f-a40e-806f2c7183e2.sql
BEGIN;
...
-- Migration: 20251215130026_bb3495d6-382a-4665-b594-a637b9434a36.sql
BEGIN;
...
-- Migration: 20251215130106_b88081de-368b-4bde-b754-521107422023.sql
BEGIN;
CREATE OR REPLACE FUNCTION public.validar_cambio_estado()
 RETURNS trigger
 LANGUAGE plpgsql
...
-- Migration: 20251215130542_e7c877bb-98c3-426e-a977-0d76c1dcacdb.sql
BEGIN;
...
-- Migration: 20260120175016_6cb7986b-c444-460b-8824-7a5da39d9393.sql
BEGIN;
...
-- Migration: 20260120175958_3b045205-b331-45f3-80d8-6d2d3f769e75.sql
BEGIN;
